...
def convert_acdc(src_data_folder: str, target_data_folder: str, dataset_id=27):
    out_dir, train_dir, labels_dir, test_dir, testlabels_dir = make_out_dirs(target_data_folder, dataset_id=dataset_id)
...
if __name__ == "__main__":
    ...
    print("Converting...")
    convert_acdc(args.input_folder, args.output_folder, args.dataset_id)
    print("Done!")
